...
--
CREATE DATABASE IF NOT EXISTS `moviles` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `moviles`;
...
CREATE TABLE `celulares` (
  ...
  `memoria_interna` varchar(255) NOT NULL,
  `memoria_ram` varchar(255) NOT NULL,
  `resolucion_camara` varchar(255) NOT NULL,
